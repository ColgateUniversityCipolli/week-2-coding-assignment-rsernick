...
\hldef{(trap.area} \hlkwb{=} \hlkwd{sum}\hldef{(((}\hlkwd{integrand}\hldef{(left.points)}\hlopt{+}\hlkwd{integrand}\hldef{(right.points))}\hlopt{*}\hldef{delta.x)}\hlopt{/}\hlnum{2}\hldef{))}
\end{alltt}
\begin{verbatim}
## [1] 8.6664
\end{verbatim}
...
\hldef{riemann.sums} \hlkwb{<-} \hlkwa{function}\hldef{(}\hlkwc{fnct}\hldef{,}                        \hlcom{# function to integrate}
  ...
  \hldef{\}}\hlkwa{else if}\hldef{(method} \hlopt{==} \hlsng{"Trapezoidial"}\hldef{)\{}
    \hldef{left.points} \hlkwb{<-} \hldef{a} \hlopt{+} \hlnum{0}\hlopt{:}\hlnum{99}\hlopt{*}\hldef{(delta.x)}
    \hldef{right.points} \hlkwb{<-} \hldef{a} \hlopt{+} \hlnum{1}\hlopt{:}\hlnum{100}\hlopt{*}\hldef{(delta.x)}
    \hldef{(area} \hlkwb{=} \hlkwd{sum}\hldef{(((}\hlkwd{integrand}\hldef{(left.points)}\hlopt{+}\hlkwd{integrand}\hldef{(right.points))}\hlopt{*}\hldef{delta.x)}\hlopt{/}\hlnum{2}\hldef{))}
